...
test_parser.add_argument("-g", "--game", type=str, default="Pong",
                    help="game to evaluate (e.g. 'Pong')")
test_parser.add_argument("-i", "--interval", type=int, default=1000,
                    help="The frame interval (default 10)")
# parser.add_argument("-m", "--mode", choices=["vision", "ram"],
#                     default="ram", help="The frame interval")
test_parser.add_argument("-hud", "--hud", action="store_true",
                    default=True, help="Detect HUD")
test_parser.add_argument("-dqn", "--dqn", action="store_true",
...
if opts.dqn:
    ...
    dqn_agent, _ = load_agent(opts, env)
...
clip = ImageSequenceClip(recorded_frames[30:], fps=30)
clip.write_videofile(f'data/datasets/{opts.game}_input.mp4')
env.close()
